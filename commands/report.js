...
module.exports = {
	...
	execute(message, args) {
		if (message.mentions.users.size) {
			...
			reportMessage(message, args);
		}
		else {
			console.log(chalkCommandFail('[REPORT FAIL]') + chalkWarning(` INVALID ARGS - USER ${message.author.tag} - ARGS ${args}`));
...
function reportMessage(message, args) {
